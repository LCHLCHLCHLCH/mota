// SDL3 键盘输入（替代 src/render/key.cpp）
...
KEY getKey() {
	int ch = getch_term();
	switch (ch) {
		case 0x103: return UP;     // SDLK_UP
		case 0x102: return DOWN;   // SDLK_DOWN
		case 0x104: return LEFT;   // SDLK_LEFT
		case 0x105: return RIGHT;  // SDLK_RIGHT
